    ...
    <div class="page__body">
      <Grid class="case">
        <GridItem class="case_item" link="/CarViolation">
          <div class="enter_icon"><img src="../assets/home/WZDJ_icon.png"></div>
          <div class="enter_text">违章代缴</div>
        </GridItem>
        <GridItem class="case_item" link="/CarLoan">
          <div class="enter_icon"><img src="../assets/home/QCDK_icon.png"></div>
          <div class="enter_text">汽车贷款</div>
        </GridItem>
        <GridItem class="case_item" link="/CarUsed">
          <div class="enter_icon"><img src="../assets/home/ESCMM_icon.png"></div>
          <div class="enter_text">二手车买卖</div>
        </GridItem>
        <GridItem class="case_item" @click.native="visit_count">
          <div class="enter_icon"><img src="../assets/home/CPZY_icon.png"></div>
          <div class="enter_text">超跑租用</div>
        </GridItem>
        <!-- <GridItem class="case_item" @click.native="coming_soon"> -->
          <!-- <div class="enter_icon"><img src="../assets/home/CPZY_icon_NO.png"></div> -->
          <!-- <div class="enter_text c_db">超跑租用</div> -->
        <!-- </GridItem> -->
        <GridItem class="case_item" link="/CarInsurance">
          <div class="enter_icon"><img src="../assets/home/QCBX_icon.png"></div>
          <div class="enter_text">汽车保险</div>
        </GridItem>
      </Grid>
    </div>
